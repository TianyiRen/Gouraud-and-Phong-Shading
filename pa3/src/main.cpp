...
void display( void )
{
	...
	/*GLMmodel* model;
    	model = glmReadOBJ("monkeytexture.obj");
...
static void setupGouraudShader()
{
...
static void setupBlinnPhongShader()
{
    printf("MSG: Initialize GLSL Shaders ...\n");
...
static void setupCheckerBoardForGShader()
{
    printf("MSG: Initialize GLSL Shaders ...\n");
    ...
    shaderProg = new GLSLProgram(CheckerboardGVS,CheckerboardGFS);
}

static void setupCheckerBoardForBShader()
{
    printf("MSG: Initialize GLSL Shaders ...\n");
    ...
    shaderProg = new GLSLProgram(CheckerboardBVS,CheckerboardBFS);
}

static void setupNormalShader()
{
    printf("MSG: Initialize GLSL Shaders ...\n");
    ...
    shaderProg = new GLSLProgram(NormalVS,NormalFS);
}
...
void keyboard( unsigned char key, int x, int y )
{
	...
	case 'a':
	printf("Gourand Shader\n");
	setupGouraudShader();
	break;

	case 's':
	printf("Blinn Phong Shader\n");
	setupBlinnPhongShader();
	break;

	case 'd':
	printf(" CheckerBoard Texture with Gouraud Shader\n");
	setupCheckerBoardForGShader();
	break;

	case 'f':
	printf(" CheckerBoard Texture with Blinn Shader\n");
	setupCheckerBoardForBShader();
	break;
